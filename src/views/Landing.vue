            ...
            <section class="section-shaped my-0">
                ...
                <div class="container shape-container d-flex">
                    <div class="col px-0">
                        <div class="row">
                            <div class="col-lg-6">
                                <h1 class="display-3  text-white">Collaborative Learning
                                    <span>and state of art in medicine</span>
                                </h1>
                                <p class="lead  text-white">Training efficiency
                                  may therefore be improved if the outcomes of collaborative learning
                                  of clinical skills are superior or equivalent to those attained
                                  through individual learning.</p>
                        ...
                        <div class="row row-grid">
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    <icon name="ni ni-bullet-list-67" type="primary" rounded class="mb-4">
                                    </icon>
                                    <h6 class="text-primary text-uppercase">Live Events</h6>
                                    <p class="description mt-3">
                                      Our webinar services offer live streaming options or the ability to record
                                       your webinar and publish to our YouTube private channel.
                                    </p>
                                    <div>
                                        <badge type="primary" rounded>oncology</badge>
                                        <badge type="primary" rounded>urology</badge>
                                        <badge type="primary" rounded>clinical</badge>
                                    </div>
                            ...
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    <icon name="ni ni-atom" type="success" rounded class="mb-4">
                                    </icon>
                                    <h6 class="text-success text-uppercase">Confidential Rounds</h6>
                                    <p class="description mt-3">
                                      Collecting medical records. Finding the best medical expert.
                                       Doctors with deep knowledge, skills and experience. Booking the appointment.
                                    </p>
                                    <div>
                                      <badge type="primary" rounded>oncology</badge>
                                      <badge type="primary" rounded>urology</badge>
                            ...
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-warning text-uppercase">Grow your network</h6>
                                    <p class="description mt-3">
                                      We provides busy health care professionals an opportunity to receive
                                      information on a variety of health care topics when and where it is convenient.
                                    </p>
                                    <div>
                                      <badge type="primary" rounded>oncology</badge>
                                      <badge type="primary" rounded>urology</badge>
            ...
            <div class="container">
                <div class="row row-grid align-items-center">
                    ...
                    <div class="col-md-6 order-md-1">
                        <div class="pr-md-5">
                            <icon name="ni ni-diamond" class="mb-5" size="lg" type="success" shadow
                                  rounded></icon>
                            <h3>Smart guidance. Qualified care</h3>
                            <p>
                              Collecting medical records. Finding the best medical expert. Doctors with deep knowledge, skills and experience. Booking the appointment. It's all done for you.
                            </p>
                            <ul class="list-unstyled mt-5">
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                                        <badge type="success" circle class="mr-3" icon="ni ni-hat-3"></badge>
                                        <h6 class="mb-0">Schedule an office events</h6>
                                    </div>
                                </li>
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                                        <badge type="success" circle class="mr-3" icon="ni ni-key-25"></badge>
                                        <h6 class="mb-0">Get an expert opinion</h6>
                                    </div>
                                </li>
                                <li class="py-2">
                                    <div class="d-flex align-items-center">
                                        <badge type="success" circle class="mr-3" icon="ni ni-satisfied"></badge>
                                        <h6 class="mb-0">Talk to a doctor today</h6>
                                    </div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row row-grid align-items-center">
                    <div class="col-md-6">
                        <div class="card bg-default shadow border-0">
                            <img v-lazy="'img/theme/photo-grandrounds.jpg'" class="card-img-top">
                            <blockquote class="card-blockquote">
                                ...
                                <h4 class="display-3 font-weight-bold text-white">Webinar System</h4>
                                <p class="lead text-italic text-white">
                                  Using Webinar software participants can share audio, documents and applications
                                  with webinar attendees. This is useful when the webinar host is conducting a lecture
                    ...
                    <div class="col-md-6">
                        <div class="pl-md-5">
                            <icon name="ni ni-books" class="mb-5" size="lg" type="warning" shadow rounded></icon>

                            <h3>Grand Rounds Video Library</h3>
                            <p class="lead">Through our platform, MGR provides busy health care
                            professionals an opportunity to receive current information on a variety of health care
                             topics when and where it is convenient.</p>
                            <p>Our webinar services offer live streaming options or the ability to record your
                               webinar and publish to our YouTube private channel.</p>

                            <a href="#" class="font-weight-bold text-warning mt-5">Access exclusive content</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <card gradient="warning"
                    ...
                    <div class="p-5">
                        <div class="row align-items-center">
                            <div class="col-lg-8">
                                <h3 class="text-white">Finding the best medical expert.</h3>
                                <p class="lead text-white mt-3">Build great network and experiences. Identify exceptional care. Get it in the hands of the everyday individual. Impact millions of lives. That’s what we do.</p>
                            </div>
            ...
            <div class="container pt-lg pb-300">
                <div class="row text-center justify-content-center">
                    <div class="col-lg-10">
                        ...
                        <p class="lead text-white">Medicne Grand Rounds draws from this venerable tradition—through
                            the connections we make to best-in-class physicians, we strive to spread knowledge on the latest in diagnosis
                            and treatment, advance clinical practice, and improve outcomes.</p>
                    </div>
                </div>
                <div class="row row-grid mt-5">
                    <div class="col-lg-4">
                        <icon name="ni ni-briefcase-24" size="lg" gradient="white" shadow round color="primary"></icon>
                        <h5 class="text-white mt-3">Schedule Events</h5>
                        <p class="text-white mt-3">We're proud to make quality care available to the millions of people who count on Medicine Grand Rounds.</p>
                    </div>
                    <div class="col-lg-4">
                        <icon name="ni ni-map-big" size="lg" gradient="white" shadow round color="primary"></icon>
                        <h5 class="text-white mt-3">Grow your network</h5>
                        <p class="text-white mt-3"> Our vision is to create a path to great health and health care for everyone, everywhere. </p>
                    </div>
                    <div class="col-lg-4">
                        <icon name="ni ni-atom" size="lg" gradient="white" shadow round color="primary"></icon>
                        <h5 class="text-white mt-3">Launch time</h5>
                        <p class="text-white mt-3">We provide an web-based technology solution that connects members and their families to high-quality care.</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row justify-content-center mt--300">
                    <div class="col-lg-8">
                        <card gradient="secondary" shadow body-classes="p-lg-5">
                            <h4 class="mb-1">Want to talk with us?</h4>
